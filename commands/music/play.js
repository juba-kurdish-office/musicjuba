...
module.exports = {
    ...
    .setID(`pause`)
    .setStyle("red")
.setEmoji('948957705257775214');

    let button2 = new MessageButton()
    .setLabel(`Resume`)
    .setID(`resume`)
    .setStyle("green")
.setEmoji('947041520429719552');

    let button3 = new MessageButton()
    .setLabel(`Skip`)
    .setID(`skip`)
    .setStyle("green")
.setEmoji('948967244065550397');
...
let rowss = new MessageActionRow()
                ...
                if (serverQueue) {
                    ...
                    if (playlist) return undefined;
                        ...
                        const sembed = new MessageEmbed()
                            .setColor("GREEN")
                            .setTitle("<:lyt:947866340876775466> Added To Queue", message.author.displayAvatarURL())
                            .setThumbnail(song.thumbnail)
                            .setTimestamp()
                            .setImage("https://cdn.discordapp.com/attachments/838086634142302208/948958628482789436/music.gif")
                            .setDescription(`**<:souer:947866565494317136> Title:** [${song.title}](${song.url}) \n\n **<:play:947038599310888960>Song Duration:** ${np} minutes \n\n **Status:** Pending`)
  ...
  const serverQueue = ops.queue.get(message.guild.id);
                ...
                const embed = new MessageEmbed()
                    .setColor("GREEN")
                    .setTitle('<:lyt:947866340876775466> Started Playing')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setImage("https://cdn.discordapp.com/attachments/838086634142302208/948958628482789436/music.gif")
                    ...
                    .setColor("GREEN")
                    .setTitle('<:lyt:947866340876775466> Song was Ended')
                    .setThumbnail(song.thumbnail)
                    .setTimestamp()
                    .setDescription(`**<:souer:947866565494317136>Title:** [${song.title}](${song.url}) \n\n **<:play:947038599310888960>Song Duration** ${np} minutes \n\n **Status:** **Finished** `)
                    .setFooter(`Played by: ${message.member.displayName} `, message.author.displayAvatarURL());
...
const { channel } = message.member.voice;
      ...
      const embed2 = new MessageEmbed()
                    ...
                    .setTimestamp()
                    .setImage("https://cdn.discordapp.com/attachments/838086634142302208/948958628482789436/music.gif")
                    .setDescription(`**<:lyt:947866340876775466>Title:** [${song.title}](${song.url}) \n\n **<:play:947038599310888960> Song Duration:** ${np} minutes \n\n **Status:** Paused by ${b.clicker.member} \n\n *Only author can skip and loop song* `)
                    .setFooter(`Played by: ${message.member.displayName}`, message.author.displayAvatarURL());
